...
//
// Bumped to 30: Codex parser now persists cwd and git branch
// metadata from session_meta. Existing rows need re-parsing so
// portable resume can resolve local repositories accurately.
//
